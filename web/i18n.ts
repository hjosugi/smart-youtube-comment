...
export const T = {
  ...
  ngChannels: D.ngChannels ?? "NG channel IDs",
  ngSave: D.ngSave ?? "Save NG list",
  backup: D.backup ?? "Backup",
  exportData: D.exportData ?? "Export",
  importData: D.importData ?? "Import",
  resetAll: D.resetAll ?? "Reset defaults",
