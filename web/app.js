...
const startLive = async (videoId, relay, startSeconds = 0) => {
  ...
  client.start(videoId, {
    onMessages,
    onState: ({ healthy, failures, replay }) => setStatus(healthy || failures < 2 ? (replay ? "replay" : "live") : "reconnecting"),
...
$("listToggle").addEventListener("click", () => settings.save({ ...cfg, listEnabled: !cfg.listEnabled }));
